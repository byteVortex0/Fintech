...
abstract class TrendingResponse with _$TrendingResponse {
  const factory TrendingResponse({required List<TrendingCoin> coins}) = _TrendingResponse;
...
abstract class TrendingCoinItem with _$TrendingCoinItem {
  ...
  factory TrendingCoinItem.fromJson(Map<String, dynamic> json) => _$TrendingCoinItemFromJson(json);
}
