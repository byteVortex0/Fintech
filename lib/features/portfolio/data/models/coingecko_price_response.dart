...
abstract class CoinGeckoPriceResponse with _$CoinGeckoPriceResponse {
  const factory CoinGeckoPriceResponse({required Map<String, CoinPriceData> prices}) =
...
abstract class CoinPriceData with _$CoinPriceData {
  const factory CoinPriceData({required double usd, required double usd24hChange}) = _CoinPriceData;
}
