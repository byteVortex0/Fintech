...
sealed class NavigationService {
  ...
  static void goToRegister(BuildContext context) => navigateTo(context, '/register');
  static void goToHome(BuildContext context) => navigateToAndRemoveUntil(context, '/home');
  static void goToFaceIdScanning(BuildContext context) => navigateTo(context, '/face_id_scanning');
  static void goToTouchIdScanning(BuildContext context) =>
      navigateTo(context, '/touch_id_scanning');
  static void goToFaceIdVerified(BuildContext context) => navigateTo(context, '/face_id_verified');
  static void goToTouchIdVerified(BuildContext context) =>
      navigateTo(context, '/touch_id_verified');
  static void goToSetFaceId(BuildContext context) => navigateTo(context, '/set_face_id');
  static void goToSetFaceIdVerified(BuildContext context) =>
      navigateTo(context, '/set_face_id_verified');
  static void goToSetFingerprint(BuildContext context) => navigateTo(context, '/set_fingerprint');
  static void goToSetFingerprintVerified(BuildContext context) =>
      navigateTo(context, '/set_fingerprint_verified');

  // Bottom navigation routes
  static void goToMarket(BuildContext context) => navigateToAndReplace(context, '/market');
  static void goToPortfolio(BuildContext context) => navigateToAndReplace(context, '/portfolio');
  static void goToSettings(BuildContext context) => navigateToAndReplace(context, '/settings');
}
